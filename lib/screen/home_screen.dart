...
import 'package:notes_app/icons.dart' show AppIcons;
import 'package:notes_app/models.dart' show CurrentUser, Note, NoteState, NoteStateX, NoteFilter;
import 'package:notes_app/services.dart' show notesCollection, CommandHandler;
import 'package:notes_app/styles.dart';
import 'package:notes_app/utils.dart';
import 'package:notes_app/widgets.dart' show AppDrawer, NotesGrid, NotesList;
...
class _HomeScreenState extends State<HomeScreen> with CommandHandler {
  ...
  Stream<List<Note>> _createNoteStream(BuildContext context, NoteFilter filter) {
    ...
    final useIndexes = sinceSignUp >= _10_min_millis;
